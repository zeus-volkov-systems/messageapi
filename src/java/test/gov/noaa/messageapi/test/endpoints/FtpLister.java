...
/**
 * <h1>FtpLister</h1> <b>Description:</b>
 * <p>
 * The core action of this endpoint is reading resource contents of FTP server
 * directories into memory as records, where each record contains information on
 * a particular directory resource (i.e., file or directory). Each of these
 * records is then assembled into the return collection, which is sent back in
 * the response.
 * <p>
 * Errors in FTP listings, whether due to directory inaccessibility, missing
 * parameters, or otherwise, will be recorded as a rejection and returned in the
 * response.
 * <p>
 ...
 * should have fields that contain directories to search. The name of these
 * fields is arbitrary and is specified in the configuration.
 * <p>
 * <h2>Configuration Parameters</h2> <b>directory-fields</b>(required)
 * (String,List(String)): The name of the fields containing directories to be
 * processed. For example, if records contain a field 'directory' that contains
 * directories to process, the config should list directory-fields: 'directory'.
 * If the records contain multiple fields with directories to process, they
 * should all be listed in the config as directory-fields: ['field1', 'field2'].
 * All of these fields will be processed.
 * <p>
 ...
 * guest.
 * <p>
 * <b>date-format</b>(optional) (String): String specifying date format to use
 * for the date-format field. Default is yyyy-MM-dd HH:mm:ss
 * <p>
 * <b>recursive</b>(optional) (Boolean): Whether or not to drill down into
 * subdirectories of the passed record directories. Defaults to false.
 * <p>
 ...
 */
public class FtpLister extends BaseEndpoint implements IEndpoint {
    ...
    public FtpLister(Map<String,Object> parameters) {
        super(parameters);
