 ...
 */
public class PassThroughEndpoint extends BaseEndpoint {

    public PassThroughEndpoint(Map<String, Object> parameters) {
        super(parameters);
    }

    /**
     * Default processing method for the pass-through endpoint. This method will gather
