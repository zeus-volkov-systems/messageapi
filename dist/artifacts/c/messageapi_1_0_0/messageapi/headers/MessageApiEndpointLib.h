...
extern "C"
{
    ...
    record_list *getRecordsByCollection(jlong message, const char *collection);
    record_list *getRecordsByTransformation(jlong message, const char *transformation);
    record_list *getRecordsByUUID(jlong message, const char *uuid);
    record_list *getRecordsByClassifier(jlong message, const char *key, const char *value);
